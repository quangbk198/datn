...
class SettingViewModel @Inject constructor(
    ...
    fun setThresholdOnFirebase(isSelectedTem: Boolean, isSelectedHumi: Boolean) {
        rxNetwork.checkInternet { isConnected ->
            if (isConnected) {
                ...
                compositeDisposable.add(
                    ...
                    ) { resultStringTem, resultStringHumi ->
                        return@zip (resultStringTem == 1) && (resultStringHumi == 1)
